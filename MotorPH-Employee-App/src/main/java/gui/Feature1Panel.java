...
public class Feature1Panel {
    ...
    public static JPanel createPanel(JFrame parentFrame,
        ...
        // onValidSearch: looks up employee, computes payroll, renders result cards
        // onClear: resets the results panel back to the placeholder state
        SearchForm searchForm = new SearchForm(
                ...
                () -> {
                    // onClear: restore the placeholder so the panel doesn't look blank
                    resultsContent.removeAll();
                    resultsContent.add(placeholder);
                    resultsContent.revalidate();
                    resultsContent.repaint();
